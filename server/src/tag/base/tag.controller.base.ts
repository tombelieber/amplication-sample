...
import { Tag } from "./Tag";
import { PlatformProviderFindManyArgs } from "../../platformProvider/base/PlatformProviderFindManyArgs";
...
export class TagControllerBase {
  ...
  @common.Get("/:id/platformProvider")
  @ApiNestedQuery(PlatformProviderFindManyArgs)
  async findManyPlatformProvider(
    @common.Req() request: Request,
    @common.Param() params: TagWhereUniqueInput
  ): Promise<PlatformProvider[]> {
    const query = plainToClass(PlatformProviderFindManyArgs, request.query);
    const results = await this.service.findPlatformProvider(params.id, {
      ...query,
      select: {
        bannerImage: true,
        createdAt: true,
  ...
  @common.Post("/:id/platformProvider")
  async connectPlatformProvider(
    @common.Param() params: TagWhereUniqueInput,
    @common.Body() body: PlatformProviderWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      platformProvider: {
        connect: body,
  ...
  @common.Patch("/:id/platformProvider")
  ...
  @common.Delete("/:id/platformProvider")
  async disconnectPlatformProvider(
    @common.Param() params: TagWhereUniqueInput,
    @common.Body() body: PlatformProviderWhereUniqueInput[]
  ): Promise<void> {
    const data = {
