...
@ArgsType()
class UpdatePlatformProviderArgs {
  @Field(() => PlatformProviderWhereUniqueInput, { nullable: false })
  where!: PlatformProviderWhereUniqueInput;
  @Field(() => PlatformProviderUpdateInput, { nullable: false })
  data!: PlatformProviderUpdateInput;
}

export { UpdatePlatformProviderArgs };
