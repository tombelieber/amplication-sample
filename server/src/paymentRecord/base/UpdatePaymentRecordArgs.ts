...
@ArgsType()
class UpdatePaymentRecordArgs {
  @Field(() => PaymentRecordWhereUniqueInput, { nullable: false })
  where!: PaymentRecordWhereUniqueInput;
  @Field(() => PaymentRecordUpdateInput, { nullable: false })
  data!: PaymentRecordUpdateInput;
}

export { UpdatePaymentRecordArgs };
